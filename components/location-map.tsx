...
import type { Location } from "@/lib/queries/creators";
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mb-12 max-w-3xl lg:mb-16">
          ...
          <p className="mt-6 max-w-2xl text-base leading-7 text-muted-foreground sm:text-lg">
            Navigate our network to discover top-tier visual
            creators across India&apos;s growing creative hubs.
          </p>
        </div>
                ...
                return (
                  <Link
                    ...
                    className={`
                      ...
                      overflow-hidden rounded-xl border px-5 py-4
                  ...
                  >
                    ...
                    <span
                      className={`
                        ...
                        bg-[#c56ac6] transition-opacity duration-300
                ...
                {locations.map((location) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span
                        className={`
                          relative flex h-3.5 w-3.5
                          items-center justify-center rounded-full
                          border-2 border-background
                          bg-[#c56ac6]
                          shadow-[0_0_18px_rgba(197,106,198,0.8)]
                          transition-transform duration-300
                          ${
                            isActive
                              ? "scale-125"
                      ...
                      <span
                        className={`
                          ...
                          mt-1.5 -translate-x-1/2 whitespace-nowrap
                          rounded-md border border-border/60
                          bg-background/90 px-2 py-1
                          text-[8px] font-semibold shadow-lg
                          backdrop-blur-md
